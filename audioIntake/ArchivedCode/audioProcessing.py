...
#mergeWavData('Qq_wJFvhfrg.wav','audiocheck.net_sin_4000Hz_-3dBFS_3s.wav','fan+4000hz.wav')
wavToCsv('carDrive-[AudioTrimmer.com] (2).wav','carDrive.csv') # maeks csv out of wav ayayayay
